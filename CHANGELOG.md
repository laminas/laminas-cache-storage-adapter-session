...
### Release Notes for [1.0.1](https://github.com/laminas/laminas-cache-storage-adapter-session/milestone/2)
...
#### Bug
 ...
 - [3: qa: remove cache dependency](https://github.com/laminas/laminas-cache-storage-adapter-session/pull/3) thanks to @boesing
